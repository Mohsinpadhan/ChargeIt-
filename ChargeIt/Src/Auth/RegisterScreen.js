...
const RegisterScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/*  */}
      <Text style={{fontSize:23,fontWeight:'600',color:'black',marginVertical:40,textAlign:'center'}}>Sign Up</Text>
      {/* fc btn */}
      <TouchableOpacity>
...
<TextInput
        ...
        <View style={styles.loginbtn}>
          <Text style={{fontSize:20,color:'white',fontWeight:'700'}}>Ragister</Text>
        </View>
        </TouchableOpacity>
